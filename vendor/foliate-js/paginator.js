...
class View {
    ...
    constructor({ container, onExpand }) {
        ...
        // MomentRead: scripts remain blocked. Upstream allowed scripts for an
        // old WebKit event bug; first-release support is verified in Chromium.
        // https://bugs.webkit.org/show_bug.cgi?id=218086
        this.#iframe.setAttribute('sandbox', 'allow-same-origin')
        this.#iframe.setAttribute('title', 'EPUB 章节正文')
